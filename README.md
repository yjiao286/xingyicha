...
桌面版免 Python、免命令行。到
[Releases 页面](https://github.com/yjiao286/bid-rigging-risk-analysis/releases)
（当前最新 [v1.4.0](https://github.com/yjiao286/bid-rigging-risk-analysis/releases/tag/v1.4.0)）
按操作系统下载对应附件：
